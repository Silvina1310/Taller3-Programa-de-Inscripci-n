...
<head>
    ...
    <title>Error alta operadores</title>
</head>
<body>
    <header>      
        <div id="titulo">   
	...
	<div class="container">
        ...
        <form action="alta-operador-error.jsp" method="post"></form>
        <div class="contenedor-alta-operador-error-">
            <a href="login.jsp">
                <p>No se ha podido dar de alta al operador</p>
            </a>
            <div>

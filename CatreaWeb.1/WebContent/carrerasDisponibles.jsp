    ...
    <div class="contenedor1">
        ...
        <div class="contenedor-menu-opcion">
            <div class="contenedor-button">
                ...
                <button type="button" class="uno"><a href="">
                            Oficial</a></button>
                </div>

                <div class="segundoopcion">
                    <button type="button" class="dos"><a href="">
                            Sub-oficial</a></button>
                </div>
                
                <div class="terceraopcion">  
                	<button type="button" class="tres"><a href="">
                            Soldado Voluntario</a></button>
                </div>

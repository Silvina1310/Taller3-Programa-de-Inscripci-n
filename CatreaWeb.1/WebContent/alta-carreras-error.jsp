...
<head>
    ...
    <title>Error alta carreras</title>
</head>
<body>
    <header>      
        <div id="titulo">   
	...
	<div class="container">
        ...
        <form action="conexion-de-carrera-error.jsp" method="post"></form>
        <div class="contenedor-alta-carrera-error-">
            <a href="login.jsp">
                <p>No se ha podido dar de alta a la carrera</p>
            </a>
            <div>

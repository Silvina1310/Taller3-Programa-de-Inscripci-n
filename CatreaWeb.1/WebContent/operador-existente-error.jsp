...
<head>
    ...
    <title>Error operador ya existente</title>
</head>
<body>
    <header>      
        <div id="titulo">   
	...
	<div class="container">
        ...
        <div class="contenedor-conexion-bd-error-">
            <a href="login.jsp">
                <p>Un operador con el DNI ingresado ya existe en la Base de Datos</p>
            </a>
            <div>
                <button type="submit" class="btn btn-primary float-right"><a href="altaOperadores.jsp">
                    Volver</a></button>
            </div>
        </div>
        </form>
